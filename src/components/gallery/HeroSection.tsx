    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <span className="inline-block px-6 py-2 border border-primary/30 rounded-full text-sm font-sans tracking-[0.3em] text-primary/80 uppercase">
        ...
        >
          <span className="gold-text text-shadow-gold">Champions</span>
        </motion.h1>
        ...
        >
          ...
          >
            <span className="text-xs tracking-[0.2em] uppercase">Przewiń</span>
